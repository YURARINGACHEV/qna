    ...
    context 'authorized' do
      ...
      context 'with valid attributes' do
        it 'saves a new answer' do
          expect do
            post api_path, params: { question_id: question, answer: attributes_for(:answer),
        ...
        it 'returns status :created' do
          post api_path,
               params: { question_id: question, answer: attributes_for(:answer), access_token: access_token.token }
      ...
      context 'with invalid attributes' do
        it 'does not save the answer' do
          expect do
            post api_path, params: { question_id: question, answer: attributes_for(:answer, :invalid),
                                     access_token: access_token.token }
    ...
    context 'authorized' do
      context 'delete the answer' do
        ...
        it 'returns json message' do
          expect(json['messages']).to include 'Answer deleted.'
        end
      end
    end
  end
